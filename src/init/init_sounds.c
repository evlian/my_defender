...
{
    game->sound_buffers.hover = sfSoundBuffer_createFromFile("./res/hover.ogg");
    game->sound_buffers.click = sfSoundBuffer_createFromFile("./res/click.ogg");
    game->sound_buffers.enemy_dies = sfSoundBuffer_createFromFile("./res/death.wav");
    game->sound_buffers.game_music = sfSoundBuffer_createFromFile("./res/gameplay.ogg");
    game->sound_buffers.intro_music = sfSoundBuffer_createFromFile("./res/intro.ogg");
    game->sound_buffers.pause = sfSoundBuffer_createFromFile("./res/pause.ogg");
    game->sound_buffers.tower_placed = sfSoundBuffer_createFromFile("./res/tower_placed.ogg");
    game->sound_buffers.archer = sfSoundBuffer_createFromFile("./res/archer.ogg");
    game->sound_buffers.mortar = sfSoundBuffer_createFromFile("./res/mortar.ogg");
}
...
void set_sound_buffers(game_instance *game)
{
    ...
    sfSound_setBuffer(game->sounds.tower_placed, game->sound_buffers.tower_placed);
